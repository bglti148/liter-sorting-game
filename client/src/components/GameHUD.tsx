...
export function GameHUD() {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none">
      ...
      {selectedItem && (
        <div className="fixed left-4 top-1/2 -translate-y-1/2 pointer-events-auto">
          <div className="bg-yellow-100/95 backdrop-blur border-2 border-yellow-400 rounded-lg shadow-lg px-6 py-3">
